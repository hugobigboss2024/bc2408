...
public class DemoStaticMethod {
    public static void main(String[] args) {
        // Approach 1:
        // Bad -> careless mistake -> wrong formula不好 -> 粗心錯誤 -> 公式錯誤
        double radius1 = 1.3;
        ...
        // if output type = String, then you must return String value inside the
        // method
    
        // Static Method
        // encrypt加密("abc") / System.out.println("hello")
        // charAt("abc", 1)
        ...
        // Compiler編譯器 knows which method the caller呼叫者 is referring during compile time.
      ...
      // if input is able to produce output如果輸入能夠產生輸出, then it is a static method.
      ...
      // Method Signature簽名 = Method Name + Number of Parameters & Type of Parameters
      // You can reuse the method name as long as they have different method
      // signature
